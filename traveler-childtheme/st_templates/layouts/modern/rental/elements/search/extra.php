...
<div class="form-group form-more-extra">
    <a href="#dropdown-more-extra" class="dropdown"><?php echo esc_html__( 'Select number of ski passes', ST_TEXTDOMAIN ) ?>
    ...
    <ul class="extras">
        <?php foreach ( $extra_price as $key => $val ):
            if ( isset( $val[ 'extra_required' ] ) && $val[ 'extra_required' ] == 'on' ) {
                ...
                <li class="item mt10">
                    <div class="st-flex space-between">
                        <span><?php echo esc_html($val['title']); ?> <span class="c-orange">*</span> </span>
            ...
            <?php } else { ?>
                <li class="item mt10">
                    <div class="st-flex space-between">
                        <span><?php echo esc_attr($val['title']); ?></span>
                        <div class="select-wrapper" style="width: 50px;">
                            <?php
                                $max_item = intval( $val[ 'extra_max_number' ] );
                                if ( $max_item <= 0 ) $max_item = 1;
