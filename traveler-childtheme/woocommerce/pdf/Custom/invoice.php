...
<table class="order-details">
	...
	<tbody>
		...
		<tr class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', $item_id, $this->type, $this->order, $item_id ); ?>">
			...
			<td class="price"><?php echo TravelHelper::format_money_from_db( $item_price, $currency );  ?>	</td>
		</tr>
		<?php if ( is_array( $data_extra ) && count( $extras ) ){ ?>
 		<tr class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', $item_id, $this->type, $this->order, $item_id ); ?>">
			<td class="product"><?php echo $data_extra['extra_skipass']['title']; ?></td>
			<td class="quantity"><?php echo $data_extra['extra_skipass']['value']; ?></td>
                        <td class="price"><?php echo TravelHelper::format_money_from_db($data_extra['extra_skipass']['price'], $currency ); ?> </td>
		</tr>
		<?php } ?>
